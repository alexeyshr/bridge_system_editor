# F09 QA Acceptance Run (2026-03-07)

Executed at: 2026-03-07T19:05:24.940Z

## Automated Checklist Evidence

- [x] 01-shell-default - Desktop shell rendered
- [x] 02-left-panel-roots-bookmarks - Left panel captured
- [x] 06-right-panel-empty-state - Right panel empty state captured before selection
- [x] select-node - Selected one visible sequence row
- [x] 03-center-classic-selected-node - Classic mode with selected node captured
- [x] 07-right-panel-node-edit-state - Right panel edit state captured
- [x] 04-center-compact-lanes - Compact lanes captured
- [x] 05-current-sequence-breadcrumb-clickable - Breadcrumb buttons detected and clicked
- [x] 09-add-continuation-disabled-bids - Disabled bids: 3
- [x] 08-add-continuation-form-open - Add continuation form opened
- [x] 10-delete-confirm-modal - Delete modal opened
- [x] 11-bookmark-list-with-dash-separators - Dash separator detected in bookmarks section
- [x] 12-mobile-overlay-mode - Mobile overlay captured
- [x] no-runtime-errors - No runtime console/page errors
